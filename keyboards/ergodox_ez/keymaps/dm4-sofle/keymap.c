...
[_0] = LAYOUT_ergodox_pretty(
  // left hand
  QK_GRAVE_ESCAPE, KC_1,    KC_2,          KC_3,    KC_4,    KC_5,  _______,  /**/  _______,  KC_6,  KC_7,   KC_8,     KC_9,    KC_0,              KC_MINS,
  ...
  _______,         _______, LALT(KC_LGUI), KC_LALT, KC_LGUI,                  /**/                   MO(_1), LM(_1, MOD_LSFT), _______, _______,   _______,
...
[_1] = LAYOUT_ergodox_pretty(
  ...
  _______,  _______, _______, _______, _______, KC_END,  _______,     _______, KC_PGDN, KC_MPRV, KC_MPLY, KC_MNXT,  _______,  _______,
  QK_BOOT,  QK_MAKE, _______, _______, _______,                                         _______, _______, _______,  KC_F11,   KC_F12,
                                                _______, _______,     _______, _______,
                                                         _______,     _______,
